...
def AHC(name, birth,password):
    ...
    driver.implicitly_wait(10) 
    time.sleep(4)
    driver.find_element_by_xpath('//*[@id="WriteInfoForm"]/table/tbody/tr[2]/td/input').send_keys(name) #이름 입력 load_ws.cell(cnt,1).value
    driver.find_element_by_xpath('//*[@id="WriteInfoForm"]/table/tbody/tr[3]/td/input').send_keys(birth) #생일 입력 load_ws.cell(cnt,2).value
